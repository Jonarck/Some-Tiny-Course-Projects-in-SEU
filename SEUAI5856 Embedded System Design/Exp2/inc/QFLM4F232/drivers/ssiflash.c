...
SSIFlashInit(void)
{
    ...
    GPIOPinConfigure(GPIO_PH0_SSI3CLK);
	  ...
	  GPIOPinConfigure(GPIO_PH3_SSI3TX);
		...
		SysCtlPeripheralEnable(SYSCTL_PERIPH_GPIOF);//CS1 CS2	
    ...
    GPIOPinTypeGPIOOutput(SFLASH_CS_BASE, SFLASH_CS_PIN);		//CS0
		GPIOPinTypeGPIOOutput(GPIO_PORTF_BASE, GPIO_PIN_6);	//CS1
		GPIOPinTypeGPIOOutput(GPIO_PORTF_BASE, GPIO_PIN_5);	//CS2	
