...
{        
	...
	ROM_GPIOPinTypeGPIOOutput(SCK_BASE, SCK_PIN);
	ROM_GPIOPinTypeGPIOOutput(CS_BASE, CS_PIN);	
	ROM_GPIOPinTypeGPIOInput(MISO_BASE, MISO_PIN);			
	ROM_GPIOPinTypeGPIOOutput(MOSI_BASE, MOSI_PIN);
}
/*******************************************************************************
